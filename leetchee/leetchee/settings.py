"""
Django settings for leetchee project.
...
SECRET_KEY = 'jzm1jiobfhfmh6p@0#&)v%isxibl@t-kr7-^(47jt#)^nd=e1@'
...
WSGI_APPLICATION = 'leetchee.wsgi.application'
